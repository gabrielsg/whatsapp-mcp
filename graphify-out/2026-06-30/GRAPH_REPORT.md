# Graph Report - whatsapp-bridge  (2026-06-26)

## Corpus Check
- 44 files · ~158,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 870 nodes · 1933 edges · 75 communities (39 shown, 36 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 134 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `626425ca`
...
Cohesion: 0.22
Nodes (9): convert_to_opus_ogg(), convert_to_opus_ogg_temp(), convert_to_opus_ogg, str, Convert an audio file to Opus format in an Ogg container and store in a temporar, Convert an audio file to Opus format in an Ogg container.      Args:, Transcribe an audio file to text using faster-whisper.      Args:         fil, transcribe_audio() (+1 more)
...
Cohesion: 0.17
Nodes (11): Commit, Concerns, Design Notes, Files Changed, Function Signature, Implementation Details, Key Features, Summary (+3 more)

### Community 68 - "Community 68"
Cohesion: 0.18
Nodes (10): Behavior, Commit, Concerns, Files Changed, Function Signature, Implementation Details, Key Features, Summary (+2 more)
...
## Knowledge Gaps
- **210 isolated node(s):** `release-type`, `include-v-in-tag`, `include-component-in-tag`, `changelog-path`, `extra-files` (+205 more)
