...
Cohesion: 0.13
Nodes (12): Architecture (read first), CI gates, Environment variables, Gotchas (read before editing), Local commands, Persona for AI agents working in this repo, PR rules, Reporting bugs / requesting features (+4 more)
